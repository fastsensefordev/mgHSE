...
@XmlRootElement(name = "UpdateChannelHostInfo")
public class UpdateChannelHostInfo {

    @XmlElementRef(name = "json", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
