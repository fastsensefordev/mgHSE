...
public class DynamicHttpclientCall {
	public static void main(String[] args) {
		...
		Client client = dcf.createClient("http://172.23.35.203:8733/VasWebService/?singlewsdl");
		// 需要密码的情况需要加上用户名和密码
		...
		try {
			...
			objects = client.invoke("AlarmInfo_GetRecordList", "year=2019");
	 ...
	 *//*
		 ...
		 * 
		 * patameterMap.put("TrackCode", "123"); patameterMap.put("Version", "123");
		 * patameterMap.put("APIDevUserID", "123"); patameterMap.put("APIPassword",
		 * "123"); patameterMap.put("APISellerUserID", "123");
		 * patameterMap.put("MessageID", "123"); patameterMap.put("TrackCode", "123");
		 * 
		 * String soapRequestData =
		 * dynamicHttpclientCall.buildRequestData(patameterMap);
		 * System.out.println(soapRequestData);
		 * 
		 * int statusCode = dynamicHttpclientCall.invoke(patameterMap); if(statusCode ==
		 * 200) { System.out.println("调用成功！");
		 * System.out.println(dynamicHttpclientCall.soapResponseData); } else {
